function changeNewsDetail1() {
	$(".canhcam-hightech-treatment-detail-news-details-1 .news-read").lightGallery({
		thumbnail: true,
		animateThumb: false,
...
function changeIMGtoDiv1(){
	$('.canhcam-hightech-treatment-detail-news-details-1 .othernews .item figure').each(function () {
